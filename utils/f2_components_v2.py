"""
Componentes compartidos Fase 2 · V2 (Excel ampliado): sidebar (solo navegacion),
filtros en area principal, header. Basado en utils/f2_components.py, apuntando
al loader utils/data_loader_v2 y a las páginas *_V2.
...
F2_NAV = [
    ("app_v2.py", "Resumen Ejecutivo", ":material/bar_chart:"),
    ("pages/4_Por_Programa_V2.py", "Resumen Por Programa", ":material/school:"),
    ("pages/3_Detalle_Etapa_V2.py", "Detalle por Etapa", ":material/assignment:"),
]
...
def render_f2_header(subtitle: str) -> None:
    st.markdown(
        ...
        "Reforma Curricular de Programas Academicos Poli <span style=\"font-size:12px;"
        "font-weight:600;opacity:.75\">· V2</span></div>"
